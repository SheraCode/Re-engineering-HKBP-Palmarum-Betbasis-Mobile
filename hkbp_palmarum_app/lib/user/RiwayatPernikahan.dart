...
import 'package:hkbp_palmarum_app/user/DetailConfirmPernikahan.dart';
...
class RiwayatPernikahan extends StatefulWidget {
  @override
  _RiwayatPernikahanState createState() => _RiwayatPernikahanState();
}

class _RiwayatPernikahanState extends State<RiwayatPernikahan> {
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      int pemasukanId = pemasukan['id_registrasi_nikah'];
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => DetailConfirmPernikahan(idRegistrasiNikah: pemasukanId),
                        ),
                      );
                    },
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: AssetImage('assets/userpernikahan.jpg'),
                          fit: BoxFit.cover,
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Pernikahan ${pemasukan['nama_laki'] ?? ''} dengan ${pemasukan['nama_perempuan'] ?? ''}',
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
