...
class DetailConfirmBaptis extends StatefulWidget {
  final int idRegistrasiBaptis;

  DetailConfirmBaptis({required this.idRegistrasiBaptis});

  @override
  _DetailConfirmBaptisState createState() => _DetailConfirmBaptisState();
}

class _DetailConfirmBaptisState extends State<DetailConfirmBaptis> {
  var height, width;
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              prefixIcon: Icon(Icons.info), // Icon surat untuk email
                            ),
                          ).p4().px24(),
                          SizedBox(height: 10),
                          if (isFileAvailable)
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => RiwayatBaptis()),
                              );
                            },
                            child: Container(
                              width: double.infinity,
