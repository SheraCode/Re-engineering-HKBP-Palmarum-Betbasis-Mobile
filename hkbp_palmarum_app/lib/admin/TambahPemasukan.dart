...
class _TambahPemasukanState extends State<TambahPemasukan> {
  ...
  Future<void> _createPemasukan() async {
    try {
      ...
      request.fields['tanggal_pemasukan'] = _dateController.text;
      ...
      if (response.statusCode == 200) {
        ...
        var snackBar = SnackBar(
          margin: EdgeInsets.only(bottom: MediaQuery.of(context).size.height - 285),
          elevation: 0,
                      ...
                      children: [
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: 'Pilih Tanggal Tanggal Pemasukan',
                            border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(30.0)),
